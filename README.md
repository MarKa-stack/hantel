...
- **Fortschritt**: Übersicht mit Kennzahlen-Fenster zum Blättern (Diese Woche mit Wochentagen, Workouts gesamt, Serie mit 8-Wochen-Leiste), Karten Erholung (→ Muskelgruppen), Gewicht & Maße, Rekorde & Meilensteine (eine Seite, zwei Reiter), Verlauf (Kalender/Wochen-Chart + letzte Workouts) einklappbar mit gemerktem Zustand; je Übung Kennzahlen (Bestes Gewicht, Top-Satz, e1RM, Volumen, Wdh) × Zeiträume (1M/3M/6M/1J/Gesamt) mit Tooltip (Datum, Gewicht × Wdh, Satz, e1RM), Veränderung („+13 kg in 5 Monaten“), Statistik und Rekorde
