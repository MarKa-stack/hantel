...
- **Trainingsmodus**: eine Übung pro Seite mit schmaler Fortschrittsleiste, Satztabelle (Nr · kg · Wdh · RIR · Haken – Werte direkt tippbar, ± in der aktuellen Zeile, RIR per Tipp durchzählen), Details hinter „⋯“ (Tipps, Scheibenrechner, Notiz, Maschineneinstellungen, Tauschen), „Letztes Training“ + „Heute empfohlen“, feste Navigation (Vorherige/Nächste/Abschließen), Auto-Speichern, automatischer **Pausentimer** mit Ton
...
- **Übungsbibliothek**: animierte Figuren aus konischen Kapseln (Start ↔ Endposition, `js/figure.js`), dazu je Übung ein **Gerätebild** (schematische SVG-Illustration von Maschine/Kabelturm/Hanteln, `js/equipment.js`) mit Aufsatz/Griff und Einstellhinweis – im Info-Sheet über „Bewegung | Gerät“ oder Tipp aufs Bild; Muskelgruppen und 2–3 Ausführungstipps zu 25 Übungen – im Plan, im Workout (ⓘ) und unter „Mehr“
